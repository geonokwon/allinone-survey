# All-in-One Survey (KT지니원 올인원 패키지 상담 신청)

KT지니원 올인원 패키지 상담 신청을 위한 **풀스택 설문 웹 애플리케이션**입니다.  
...
- **대상**: KT지니원 올인원 패키지 관심 고객(업종·지역·필요 상품·상담 가능 시간 등 수집)
...
Private. KT지니원 관련 상담 신청용 프로젝트입니다.

---

## 연락처

- Repository: [github.com/geonokwon/allinone-survey](https://github.com/geonokwon/allinone-survey)
